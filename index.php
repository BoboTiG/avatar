 ...
 * The background color is defined by the CRC32 of the first argument.
 * The letter used is the first character of the argument.
 *
 * To retrieve the image, call this page with the 't' GET parameter:
 *      index.php?t=blablabla
 */
class Avatar
{
